<div>
    <x-breadcrumb :links="[
        ...
        ['text' => 'Agendamentos', 'url' => route('admin.appointments.index')],
    ]" />
    <!-- Filtros -->
    <div class="bg-white p-6 rounded-lg shadow mb-6">
        <h2 class="text-lg font-semibold text-gray-700 mb-4">Filtrar Agendamentos</h2>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-lg font-semibold text-gray-700 mb-4">Lista de Agendamentos</h2>
