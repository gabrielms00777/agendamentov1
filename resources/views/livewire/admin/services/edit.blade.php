            ...
            <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                ...
                <div class="p-4 overflow-y-auto">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" wire:model="form.name" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:text-neutral-400" placeholder="Service Name" autofocus>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" wire:model="form.description" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:text-neutral-400" placeholder="Service Description"></textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="duration" wire:model="form.duration" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:text-neutral-400" placeholder="Duration in minutes">
                        @error('form.duration') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                    </div>
